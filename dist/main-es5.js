...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _server_contact_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./server/contact.service */
    "./src/app/server/contact.service.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _contacts_contacts_component__WEBPACK_IMPORTED_MODULE_6__["ContactsComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"]],
      providers: [_server_contact_service__WEBPACK_IMPORTED_MODULE_3__["ContactService"]],
  ...
  function srcAppContactsContactsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _server_contact_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../server/contact.service */
    "./src/app/server/contact.service.ts");
    ...
    function () {
      ...
      _createClass(ContactsComponent, [{
        ...
        value: function addContact() {
          ...
          this.contactService.createContact(this.first_name, this.last_name, this.birthday).subscribe(function (data) {
            return _this.contacts.push(newContact);
          }, function (err) {
        ...
        value: function deleteContact(id) {
          ...
          this.contactService.deleteContact(id).subscribe(function (data) {
            _this2.contacts.forEach(function (contact, index) {
              if (contact._id === id) {
    ...
    ContactsComponent.ctorParameters = function () {
      return [{
        type: _server_contact_service__WEBPACK_IMPORTED_MODULE_2__["ContactService"]
      }];
    };
  ...
  /***/
  function srcAppServerContactServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      function ContactService(http) {
        ...
        this.http = http;
        this.URL = "https://contactsapp-joseluru95.herokuapp.com/api";
      }

      _createClass(ContactService, [{
        key: "getContacts",
        value: function getContacts() {
          return this.http.get("".concat(this.URL, "/contacts"));
        }
      }, {
        key: "createContact",
        value: function createContact(first_name, last_name, birthday) {
          return this.http.post("".concat(this.URL, "/contact"), {
        ...
        key: "deleteContact",
        value: function deleteContact(id) {
          return this.http.delete("".concat(this.URL, "/contact/").concat(id));
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Jose Luis\Desktop\MEAN - Contact list\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
